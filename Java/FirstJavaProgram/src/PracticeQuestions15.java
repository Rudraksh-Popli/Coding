...
public class PracticeQuestions15
{
    public static void main(String[] args)
    {
        // 1. Create an ArrayList and store the names of ten students inside it.
        ...
        // 5. Create a Set in java. Try to store the duplicate values elements inside this set
